...
#COMPORTEMENT SELON TYPE VEHICULE ?        
    ...
    def accelerer(self, vitesse_limite, pas):
        ...
        limite = self._type_conducteur.coef_vitesse * vitesse_limite
        ...
        if dvitesse >= (2*pas):
            ...
            nouvelle_vitesse = self._vitesse + 2*pas
        else:  
    ...
    def depasser(self, nb_voies):
        ...
        if self._voie.id_voie != -1 and self._voie.id_voie != nb_voies - 1:
    ...
    def prendre_la_sortie(self, pas):
        ...
        self._prend_la_sortie:
            ...
            if self._position >= 600 and distance_devant > 0.6 * self._vitesse:
                ...
                self._voie = self._voie.voie_droite
                #Mise a jour de liste de vehicules de la sortie
                self._voie.liste_vehicules.append(self)
